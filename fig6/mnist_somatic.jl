...
function main_mnist_local(plotflag, dt, s)
    print("Setting up...\n")
    nInitPatterns = 40000
    nPatterns = 120000
    nTestPatterns = 1000
    ...
    return main("mnist_random_start_local", plotflag, s, nSteps, inputs, test_inputs, test_times, 
...
main_mnist_local(plotflag, dts[id], copy(standardSettings))
