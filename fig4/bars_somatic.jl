...
function main_bars_local(plotflag, s, corr, noise, id)
    print("Setting up...\n")
    nPatterns = 1000000
    nTestPatterns = 500
    ...
    return main("bars_somatic", plotflag, s, nSteps, inputs, test_inputs, test_times, name="$(id)_$(corr)")
end
...
noise = 0.0
net = main_bars_local(plotflag, copy(standardSettings), corr, noise, id)
loss = net.log.temp["test_decoder_loss"][end]
mkpath("../../bars_local/logs/")
file = open("../../bars_local/logs/results$id.txt", "w")
