...
function setup_temp_log(net::Net, nSteps::Int, interval::Int)::Dict{String, Any}
    ...
    # mean xz weights
    net.log.temp["mean_xz_weights"] = zeros(div(nSteps, interval), 2)
    runningLog["mean_xz_weights"] = zeros(2)
    ...
    net.log.temp["pruning_coefficients"] = zeros(div(nSteps, interval), net.n_z * net.n_z * net.n_x)
...
function update_running_log(net::Net, runningLog::Dict{String,Any},
    ...
    runningLog["mean_xz_weights"][1] += mean(net.xz_weights) / numSamples
    ...
    net.memory["z_cov"] += net.z_outputs * net.z_outputs' ./ numSamples
end
...
function log_temp_log(net::Net, runningLog::Dict{String,Any},
    ...
    net.log.temp["pruning_coefficients"][k, :] = vec(net.memory["pruning_coefficients"])
