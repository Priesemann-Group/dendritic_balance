...
# fraction of 'dendritic' weights to be pruned
standardSettings["pruningFraction"] = 0.0
# correlation between coding neurons has to be learned to estimate which weights to prune
standardSettings["learningRateCorrelation"] = 0.001
# pruning proceeds 'factor' times fater than inhibitory platicity
standardSettings["learningFactorPruning"] = 4.0
...
standardSettings["learningRateFeedForwardBar"] = 0.00006
